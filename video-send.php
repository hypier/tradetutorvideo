...
<?php
    ...
    $sql_query = "SELECT g.*, c.category_name FROM tbl_gallery g, tbl_category c WHERE g.cat_id = c.cid AND g.id = '$ID'";
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($data['video_type'] == 'youtube') {
            ...
            $bigImage = $actualLink.'/upload/'.$data['video_thumbnail'];
        }
                                    ...
                                    <?php if ($provider == 'onesignal') { ?>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="message" id="message" placeholder="Message" value="<?php echo $data['video_title']; ?>" required/>
                                                </div>
                                            </div>
